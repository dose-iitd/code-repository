...
class Trainer(object):
    def __init__(self, args):
        ...
        #checkpoint = torch.load('/home/nikhil/scratch/CIConv_zero_shot/experiments/rloss/pytorch/pytorch-deeplab_v3_plus/ciconv-master/experiments/3_segmentation/cityscapes_w.pth.tar')
